        ...
        <div class="box box-default">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?= get_base_url(); ?>cron/create/" data-toggle="tab"><?= _t('New Cronjob Handler'); ?></a></li>
            ...
            <!-- form start -->
            <form method="post" action="<?= get_base_url(); ?>cron/create/" data-toggle="validator" autocomplete="off">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
