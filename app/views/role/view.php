...
<div class="content-wrapper">
    ...
    <?= _tc_flash()->showMessage(); ?> 
        ...
        <div class="box box-default">
            <!-- form start -->
            <form method="post" action="<?= get_base_url(); ?>role/editRole/" data-toggle="validator" autocomplete="off">
                <div class="box-body">

                    <!-- Group -->
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="roleName"><font color="red">*</font> <?= _t('Role Name'); ?></label>
                        <div class="col-md-12"><input class="form-control" name="roleName" type="text" value="<?= _h($role->roleName); ?>" required/></div>
                    </div>
                    <!-- // Group END -->
