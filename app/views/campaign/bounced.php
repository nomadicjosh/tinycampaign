...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?= _t('Emails Bounced Campaign Report'); ?></h1> <br /><span class="label bg-green-gradient" style="font-size:1em;font-weight: bold;"><?=_t('Total Bounces');?>: <?= _escape($cpgn->bounces); ?></span>
        <ol class="breadcrumb">
