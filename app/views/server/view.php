...
<?= _tc_flash()->showMessage(); ?>
        ...
        <div class="box box-default">
            <!-- form start -->
            <form method="post" action="<?= get_base_url(); ?>server/<?=_h($server->id);?>/" data-toggle="validator" autocomplete="off">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="box box-default">
            ...
            <!-- form start -->
            <form method='post' action='<?= get_base_url(); ?>server/<?=_h($server->id);?>/test/'>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
