                    ...
                    <tbody>
                        ...
                        if ($listPerms != '') {
                            foreach ($listPerms as $k => $v) {
                                ...
                                echo '<td class="text-center"><a href="' . get_base_url() . 'permission/' . _h((int)$v['ID']) . '/" data-toggle="tooltip" data-placement="top" title="View/Edit" class="btn bg-yellow"><i class="fa fa-edit"></i></a></td>';
                                echo '</tr>' . "\n";
                            }
                        }
