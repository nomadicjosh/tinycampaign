...
TinyC\Config::set('screen_child', 'perm');
?>
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <!-- form start -->
            <form method="post" action="<?=get_base_url();?>permission/<?=_h((int)$perm->id);?>/" data-toggle="validator" autocomplete="off">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="permName" value="<?=$ePerm->getPermNameFromID(_h((int)$perm->id));?>" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="permKey" value="<?=$ePerm->getPermKeyFromID(_h((int)$perm->id));?>" required>
                            </div>
