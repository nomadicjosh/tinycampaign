                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status" style="width: 100%;" required>
                                    <option>&nbsp;</option>
                                    <option value="1"<?=selected('1',(_h((int)$app->req->post['status']) != '' ? _h((int)$app->req->post['status']) : ''),false);?>><?=_t('Active');?></option>
                                    <option value="0"<?=selected('0',(_h((int)$app->req->post['status']) != '' ? _h((int)$app->req->post['status']) : ''),false);?>><?=_t('Inactive');?></option>
                                </select>
