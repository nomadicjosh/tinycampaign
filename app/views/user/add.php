                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="uname" value="<?=_h($app->req->_post('uname'));?>" required>
                            </div>

                            <div class="form-group">
                                <label><font color="red">*</font> <?= _t('First Name'); ?></label>
                                <input type="text" class="form-control" name="fname" value="<?=_h($app->req->_post('fname'));?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label><font color="red">*</font> <?= _t('Last Name'); ?></label>
                                <input type="text" class="form-control" name="lname" value="<?=_h($app->req->_post('lname'));?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label><font color="red">*</font> <?= _t('Email'); ?></label>
                                <input type="text" class="form-control" name="email" value="<?=_h($app->req->_post('email'));?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label><?= _t('Address1'); ?></label>
                                <input type="text" class="form-control" name="address1" value="<?=_h($app->req->_post('address1'));?>" >
                            </div>
                            
                            <div class="form-group">
                                <label><?= _t('Address2'); ?></label>
                                <input type="text" class="form-control" name="address2" value="<?=_h($app->req->_post('address2'));?>" >
                            </div>
                            
                            <div class="form-group">
                                <label><?= _t('City'); ?></label>
                                <input type="text" class="form-control" name="city" value="<?=_h($app->req->_post('city'));?>" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="state" style="width: 100%;">
                                    <option>&nbsp;</option>
                                    <?php table_dropdown('state',null,'code','code','name',_h($app->req->_post('state'))); ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="postal_code" value="<?=_h($app->req->_post('postal_code'));?>" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="country" style="width: 100%;">
                                    <option>&nbsp;</option>
                                    <?php table_dropdown('country',null,'iso2','iso2','short_name',_h($app->req->_post('country'))); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="roleID" style="width: 100%;" required>
                                    <option>&nbsp;</option>
                                    <?php get_user_roles(_h($app->req->_post('roleID'))); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status" style="width: 100%;" required>
                                    <option>&nbsp;</option>
                                    <option value="1"<?=selected('1',_h($app->req->_post('status')),false);?>><?=_t('Active');?></option>
                                    <option value="0"<?=selected('0',_h($app->req->_post('status')),false);?>><?=_t('Inactive');?></option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="password" value="<?=_random_lib()->generateString(12);?>" >
                            </div>
