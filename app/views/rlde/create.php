...
TinyC\Config::set('screen_parent', 'rules');
TinyC\Config::set('screen_child', 'crule');
...
<?= _tc_flash()->showMessage(); ?>
        ...
        <div class="alert alert-info"><?=_t('If you make any changes, you must click "Load Rule" in order to bring the changes to the screen and then click "Save".');?></div>
