        ...
        <div class="box box-default">
            <pre>
                <?php
                    ...
                    $report .= "Active User Count:"."\t\t\t\t\t".$user.PHP_EOL;
                    $report .= sprintf("DB Errors:"."\t\t\t\t\t\t".($error <= 0 ? '<font color="green">0</font>' : '<font color="red">'.$error.'</font> (<a href="%s"><strong>Click Here</strong></a>)'), get_base_url() . 'error/').PHP_EOL;
