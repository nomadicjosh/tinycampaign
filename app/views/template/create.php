...
app\src\Config::set('screen_child', 'ctpl');
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <!-- form start -->
            <form method="post" action="<?= get_base_url(); ?>template/create/" data-toggle="validator" autocomplete="off">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label><?= _t('Created'); ?></label>
                                <input type="text" class="form-control" value="<?= Jenssegers\Date\Date::now()->format('M. d, Y @ h:i A');?>" readonly/>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control template" rows="3" name="content" required><?=(_h($app->req->post['content']) != '' ? _h($app->req->post['content']) : '');?></textarea>
                            </div>
