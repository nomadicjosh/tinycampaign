...
class tc_EmailOauth
{
     ...
     * @return mixed
     */
    public function tc_mail_oauth($to, $subject, $message, $headers = '', $attachments = array())
    {
        $charset = 'UTF-8';

        /**
         * Filter the tc_mail_oauth() arguments.
         *
         * @since 2.0.0
         *       
         * @param array $args
         *            A compacted array of tc_mail_oauth() arguments, including the "to" email,
         *            subject, message, headers, and attachments values.
         */
        $atts = $this->app->hook->{'apply_filter'}('tc_mail_oauth', compact('to', 'subject', 'message', 'headers', 'attachments'));
         ...
         */
        $this->mailer->From = $this->app->hook->{'apply_filter'}('tc_mail_oauth_from', $from_email);
         ...
         */
        $this->mailer->FromName = $this->app->hook->{'apply_filter'}('tc_mail_oauth_from_name', $from_name);
        ...
        /**
         * Filter the tc_mail_oauth() content type.
         *
         * @since 2.0.0
         *       
         * @param string $content_type
         *            Default tc_mail_oauth() content type.
         */
        $content_type = $this->app->hook->{'apply_filter'}('tc_mail_oauth_content_type', $content_type);
        ...
        /**
         * Filter the default tc_mail_oauth() charset.
         *
         * @since 2.0.0
         *       
         ...
         */
        $this->mailer->CharSet = $this->app->hook->{'apply_filter'}('tc_mail_oauth_charset', $charset);
    ...
    public function sendNewUserEmail($user, $pass)
    {
        ...
        $message = __('Hi there,') . "\r\n\r\n";
        $message .= sprintf(__("Welcome to %s! Here's how to log in:"), $site) . "\r\n\r\n";
        $message .= get_base_url() . "\r\n";
        $message .= sprintf(__('Username: %s'), $user->uname) . "\r\n";
        $message .= sprintf(__('Password: %s'), $pass) . "\r\n\r\n";
        $message .= sprintf(__('If you have any problems, please contact me at %s.'), get_option('system_email')) . "\r\n\r\n";
        ...
        $this->tc_mail_oauth(_h(get_option('system_email')), _t("New Account"), $message, $headers);
