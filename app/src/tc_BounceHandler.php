...
class tc_BounceHandler
{
     ...
     * @var string
     */
    public $action_function = 'bounce_callback_action';
    ...
    function processBounce($pos, $type, $totalFetched)
    {
        ...
        if ($type == 'DSN') {
            ...
            $result = bounce_dsn_rules($dsn_msg, $dsn_report, $this->debug_dsn_rule);
        } elseif ($type == 'BODY') {
            ...
            switch ($structure->type) {
                ...
                case 1: // Content-type = multipart
                    ...
                    $result = bounce_body_rules($body, $structure, $this->debug_body_rule);
                    break;
