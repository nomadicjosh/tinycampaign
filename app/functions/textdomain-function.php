 ...
 * @param string $plugin_rel_path Optional. Relative path to TC_PLUGIN_DIR where the locale directory resides.
 *                                Default false.
 ...
 * @param string $active
 */
function tc_dropdown_languages($active = '')
{
 ...
 */
function tc_remove_accents($string)
{
...
function tc_sanitize_string($string, $fallback_string = '', $context = 'save')
{
    ...
    if ('save' == $context)
        $string = tc_remove_accents($string);
