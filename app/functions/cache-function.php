 ...
 *         contents on success.
 */
function tc_cache_get($key, $namespace = '')
{
    $cache = _tc_cache_init();
 ...
 */
function tc_cache_delete($key, $namespace = '')
{
    $cache = _tc_cache_init();
 ...
 * @return bool False on failure, true on success
 */
function tc_cache_flush_namespace($value)
{
    $cache = _tc_cache_init();
 ...
 */
function tc_cache_increment($key, $offset = 1, $namespace = '')
{
    $cache = _tc_cache_init();
 ...
 * @return false|int False on failure, the item's new value on success.
 */
function tc_cache_decrement($key, $offset = 1, $namespace = '')
{
    $cache = _tc_cache_init();
